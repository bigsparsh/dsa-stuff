...
public:
  ...
  std::string getPartNumber() { return partNum; }
  std::string getPartDescription() { return partDesc; }
  int getItemQuantity() { return itemQuantity; }
  double getPricePerItem() { return pricePerItem; }
  void setPartNumber(std::string n) { partNum = n; }
  void setPartDescription(std::string pd) { partDesc = pd; }
  void setItemQuantity(int iq) { itemQuantity = iq; }
  void setPricePerItem(double ppi) { pricePerItem = ppi; }
