// Create a Base class that consists of private, protected and public data
...
// the above three modes (when derived in public, protected and private modes)
// and shows the access specifier of the members of base class in the Derived
// class.
...
private:
  void privateMethod() { cout << "Private method of Base class" << endl; }

protected:
  void protectedMethod() { cout << "Protected method of Base class" << endl; }

public:
  void publicMethod() { cout << "Public method of Base class" << endl; }
};
